		...
		[
			[
				...
				[
					...
					"Votre nom ne doit pas contenir de lettres provenant de différentes langues."
				]
			],
			[
				"Règles du chat",
	...
	"darkrp": [
		...
		[
			[
				"Section principale",
				[
					`Votre nom rôleplay doit être réaliste (et non Chat Miaou, L'Homme Crabe), il ne devra pas contenir de ponctuation et devra suivre les règles générales de capitalisation des mots.`,
					...
					`Les chefs de gangs sont "invisibles" - ils ressemblent à des citoyens normaux (ce qui signifie que vous ne pouvez pas fouiller un chef de gang, juste parce que vous voyez qu'il est chef).<br>
					...
					`Ne faites pas quelque chose de stupide qu'une personne normale ne ferait pas, c'est-à-dire:
						<ul>
			...
			[
				...
				[
					...
					`Évitez d'utiliser le chat vocal si votre voix est désagréable et qu'on vous le fait remarquer.`,
			...
			[
				...
				[
					...
					`Tous les mandats et les couvres-feu doivent être suivis par une raison cohérente. Les raisons telles que "lol", "fouille", "ccccccc" sont invalides.`,
					...
					`Les fouilles pour trouver des armes n'exigent pas de mandat (mais une raison valide est requise).<br>
			...
			[
				...
				[
					...
					`Le client est responsable en cas d'exécution aléatoire, et non le mercenaire.`,
				]
			],
			[
				...
				[
					...
					`Les objets, cachés derrière/dessous/dessus un prop, devront être accessibles avec un keypad ou un bouton et être crochettables.`,
					...
					`Il est interdit de faire des sols, des échelles, des ascenseurs et des plateformes disparaissants.`,
