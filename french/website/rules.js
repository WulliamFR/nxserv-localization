		...
		[
			[
				...
				[
					...
					"Votre nom ne doit pas avoir des mots avec différentes lettres de différentes langues."
				]
			],
			[
				"Règles du chat",
				[
					"Vous ne devriez pas insulter les autres joueurs.",
					"Toute forme d'affirmation ressentie et insensée (\"ce serveur est nul\", et autres) vous menera uniquement vers un ban.",
			...
			[
				...
				[
					"Soyez polis et patient quand vous communiquez avec un administrateur.",
					"Quand vous appellez un administrateur, vous devez indiquer le problème et le nom du joueur offensant.",
					...
					"Les administrateurs ne sont pas à votre disposition. Ils ne sont pas obligés de répondre."
				]
			]
		]
	],
	...
	"darkrp": [
		...
		[
			...
			[
				"Règles du chat",
				[
					`N'envoyez pas d'informations roleplay dans le chat HRP (MetaGaming).<br>
						Vous n'êtes pas autorisé à utiliser des informations obtenues dans le chat HRP (Hors Role Play).`,
					`N'utilisez pas le HRP pour communiquer avec une personne en particulier.<br>
