	...
	"global": [
		...
		[
			[
				"Section Principale",
				[
					"Il est interdit d'utiliser des logiciels ou des bugs, qui peuvent procurer un avantage sur les autres joueurs (Cheats, UseBug).",
					"Il est interdit de perturber le fonctionnement du serveur.",
					"Il est interdit d'outrepasser le ban d'un compte.",
					`Les joueurs doivent informer l'administration des problèmes importants, qui peuvent faire crasher le serveur ou désavantager les autres joueurs.
					<br>Il est punissable de posséder et de cacher de telles informations, ainsi que de les transmettre à d'autres joueurs.`,
					"Votre nom ne doit pas avoir de lettres provenant de différentes langues."
				]
			],
			[
				"Règles du chat",
				[
					...
					"Vous devrez utiliser le chat global pour contacter un administrateur uniquement dans les cas critiques (quelqu'un essaie de faire crash le serveur ou utilise un cheat).",
		...
		[
			[
				...
				[
					...
					`Il est interdit de se suicider, de se déconnecter puis se reconnecter, ou bien même de changer de métier pour échapper à une situation RP, tel que des poursuites par la police, des braquages, être pris en otage, la faim ou autre.`,
					...
					`Les chefs de gangs sont "invisibles" - ils ressemblent à un citoyen normal (ce qui signifie que vous ne pouvez pas fouiller un chef de gang, juste parce que vous voyez qu'il est chef).<br>
					...
					`Ne faites pas quelque chose de stupide qu'une personne normale ne ferait pas faire, c'est-à-dire:
						<ul>
							<li>Faire apparaître 1 000 000 affiches qui disent "zone de kill".
							<li>Demander à un policier de vous tuer juste car vous avez faim.
							<li>Sauter dans le feu avec courage, là où la sortie est inaccessible.
							<li>Rester devant une voiture en mouvement.
						</ul>`,
					`Tout vote de renvoi (Premium seulement) doit avoir une raison appropriée et être en accord avec les règles, sans insultes. Vous n'êtes pas autorisés à initier des votes de renvoi s'il n'y a aucune règle qui n'est pas respectée.`,
			...
			[
				...
				[
					...
					`Évitez d'utiliser le chat vocal si votre voix est insupportable et qu'on vous le fait remarquer.`,
					`Le téléphone est une partie du RP, ne l'utilisez pas pour contacter un administrateur afin d'obtenir de l'aide.`,
					`Ne menacez pas les autres joueurs de les bannir. Vous n'êtes pas un modérateur.`,
				]
			],
			[
				...
				[
					...
					`Tous les mandats et les couvres-feu doivent être suivis par une raison cohérente. Les raisons tel que "lol", "fouille", "ccccccc" sont invalides.`,
					...
					`La police est autorisée à construire des barrières, des points de contrôle, des dos-d'ânes et à bloquer des rues ou des bâtiments. Toutes les barrières qui bloquent quelque chose doivent avoir un entrée crackable.`,
					`Les fouilles pour trouver des armes n'exigent pas de mandat (mais une raison adéquate est requise).<br>
			...
			[
				...
				[
					`Si un de vos clients vous agresse ou vous insulte, perturbe la paix dans votre échoppe ou est recherché par la police, vous pouvez vous réserver le droit de ne pas servir celui-ci.<br/>
						Dans le cas contraire où le client n'a rien fait de mal, vous vous devez de le servir.`,
					`Les vendeurs d'armes, les médecins, les commerçants (Barman, etc) ne sont pas autorisés à utiliser leurs capacités à des fins criminelles ou de participer à des activités criminelles.`,
			...
			[
				...
				[
					...
					`Le client est responsable en cas d'exécution aléatoire, pas le mercenaire.`,
				]
			],
			[
				...
				[
					...
					`Vos constructions doivent être réalistes: elles doivent être plus bas que la skybox, avoir un support (un vrai support, et non un cylindre avec un ascenseur), et ne devra pas changer de couleur rapidement.`,
					...
					`Il est interdit de faire des sols, des échelles, des ascenseurs et des plateformes disparaissant`,
