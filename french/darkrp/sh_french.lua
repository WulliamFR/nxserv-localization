local french = {
	...
	hits_menu_subscriptions_title = "\"Offres business\"",
	...
	hits_menu_subscriptions_empty = "Il n'y a pas encore de contrats, regardez vos notifications.",
	hits_menu_subscriptions_subscribe =  "S'inscrire",
	hits_menu_subscriptions_unsubscribe =  "Se désinscrire",

	hits_menu_makehit_title = "Commander des services mercenaires",
	...
	hits_menu_makehit_submit = "Faites un meurtre !",
